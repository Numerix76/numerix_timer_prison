...
TimerPrison.Language.VersionDefault = "1.0.3" --DON'T TOUCH THIS

TimerPrison.Language["default"] = {
	["Current task: %s for %s"] = "Current task: %s for %s",
	...
	--1.0.1
	["Lockdown ! Go to cells !"] = "Lockdown ! Go to cells !",
}